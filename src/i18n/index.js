...
const STR = {
  es: {
    ...
    "title.hint.touch": "Un dedo en la pantalla: el carro va hacia tu dedo · lejos = rápido, bien lejos = turbo · ✋ drift",
  ...
  en: {
    ...
    "title.hint.touch": "One finger on screen: the car drives toward it · far = fast, very far = turbo · ✋ drift",
