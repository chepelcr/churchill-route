...
const inventory = {
  ...
  catalogs: {
    ...
    lightTypes: ["warm", "led", "amber", "stadium"],
    signalStyles: ["roadside", "centered", "overhead"],
    trafficSigns: ["alto", "ceda", "bus", "crossing", "tope", "banca"],
    attractionKinds: ["carrusel", "rueda", "chocones", "tombola", "dj"],
    roadMarkings: ["speed_limit"],
    npcTypes: ["resident", "tourist", "vendor", "worker", "supporter", "mascot"],
    npcMovements: ["stationary", "wander", "route"],
    npcDrawStyles: ["person", "vendor", "worker", "mascot"],
    coinTypes: ["gold", "silver", "bonus", "frozen"],
    weatherModes: ["sunny", "sunset", "storm", "night"],
