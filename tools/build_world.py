...
from churchill.world.pipeline.poi_stage import (  # noqa: E402
    place_kiosks_and_blocks, place_pois,
)
from churchill.world.pipeline.surface_stage import (  # noqa: E402
    rasterise_surface, resolve_districts,
)
...
def main():
    ...
    (blocks, plazas, greens, kiosk_paths, beach_kiosks, faro_lm, faro_pier,
     balneario, balneario_cells, marine_site) = place_kiosks_and_blocks(
        ...
        NO_PAD_LM=NO_PAD_LM)
    # Bindings the later phases still use, now that `blocks` exists. They go
    # when those phases become stages too.
