...
export const VEHICLES = {
  ...
  pickup:  { name: "Pickup pescador",      accel: 253, top: 270, turn: 2.45, grip: 0.78, melt: 1.1, color: "#6fbf99", roof: "#4a3a2a", w: 31, h: 19, kind: "car"  },
  turbo:   { name: "Turbo Churchill Kart", accel: 330, top: 352, turn: 3.05, grip: 0.72, melt: 1.3, color: "#ff3d80", roof: "#fff36b", w: 25, h: 14, kind: "car"  },
};
