# ROADMAP — el archivo histórico

Todo lo que `ROADMAP.md` acumuló entre 2026-07-05 y 2026-08-14, íntegro y sin
editar. Se movió aquí el 2026-08-14 porque el archivo vivo había llegado a 2 400
líneas y varias de sus secciones más viejas ya decían cosas falsas — que no había
audio, que toda la interfaz estaba en español duro, que el mapa 2-D estaba
pendiente — de modo que leerlo entero costaba más que no leerlo.

**Nada de esto se borró: se archivó.** El "por qué" de una decisión vieja sigue
siendo lo más útil que hay escrito en este repo, y varias de las entradas de aquí
abajo son la única explicación que existe de por qué algo está como está. Lo que
cambió es que el archivo VIVO ahora contiene sólo trabajo abierto.

Las notas de entrega por fecha están en `docs/changelog/`. Éste es el registro de
PLANIFICACIÓN, que es otra cosa: aquí está lo que se pensó hacer, incluido lo que
