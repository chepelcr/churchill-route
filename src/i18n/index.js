...
const STR = {
  es: {
    ...
    "title.hint.touch": "Joystick = dirección · otro dedo en la pantalla = velocidad (lejos del carro = rápido, bien lejos = turbo) · ✋ drift",
    ...
    "tut.steer.touch": "El joystick de abajo a la izquierda es la DIRECCIÓN: movelo y el carro gira hacia donde apunta. Da una vuelta.",
    "tut.steer.keys": "Manejá con WASD o las flechas. Da una vuelta.",
    "tut.speed.touch": "Con el OTRO dedo tocá la pantalla: es el acelerador. Cerca del carro = despacio, lejos = a fondo.",
    "tut.speed.keys": "Mantené W para acelerar a fondo.",
    "tut.turbo.touch": "¡TURBO! Poné el dedo del acelerador BIEN LEJOS del carro y mantenelo.",
    ...
    "results.doubleAd": "▶ Duplicar monedas (ver anuncio)",
  ...
  en: {
    ...
    "title.hint.touch": "Joystick = steering · second finger on screen = speed (far from the car = fast, very far = turbo) · ✋ drift",
    ...
    "tut.steer.touch": "The bottom-left joystick is your STEERING: move it and the car turns that way. Take a lap.",
    "tut.steer.keys": "Drive with WASD or the arrow keys. Take a lap.",
    "tut.speed.touch": "Touch the screen with your OTHER finger: that's the throttle. Near the car = slow, far = full speed.",
    "tut.speed.keys": "Hold W to go full speed.",
    "tut.turbo.touch": "TURBO! Hold your throttle finger VERY FAR from the car.",
    ...
    "results.doubleAd": "▶ Double coins (watch ad)",
